...
public class Maze : MonoBehaviour
{
    ...
    void initMaze()
    {
        ...
        {
            GameObject temp = Instantiate(sampleRow, transform.position+new Vector3(transform.position.x, -1*i* traits.scale/*+traits.forceCloser*i*/, 0), Quaternion.identity, transform);
            temp.name = "Row " + i;
