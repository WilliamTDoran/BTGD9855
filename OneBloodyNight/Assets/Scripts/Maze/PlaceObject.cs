...
public class PlaceObject
{
    ...
    public static void place(Biome b, PlacableObject obj)
    {
        ...
        GameObject placed = GameObject.Instantiate(obj.formation, new Vector3(Maze.m.traits.scale * x, -1 * Maze.m.traits.scale * y, obj.formation.transform.position.z), new Quaternion());
